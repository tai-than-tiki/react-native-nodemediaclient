...
public class NodeCameraViewManager extends ViewGroupManager<RCTNodeCameraView> {
    ...
    private static final int COMMAND_RELEASE_CAMERA_ID = 6;
    private static final String COMMAND_RELEASE_CAMERA = "release";
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.of(COMMAND_STARTPREV_NAME, COMMAND_STARTPREV_ID, COMMAND_STOPPREV_NAME, COMMAND_STOPPREV_ID,
                ...
                COMMAND_SWITCH_CAM_ID, COMMAND_SWITCH_FLASH_NAME, COMMAND_SWITCH_FLASH_ID, COMMAND_RELEASE_CAMERA, COMMAND_RELEASE_CAMERA_ID);
    }
    ...
    public void receiveCommand(RCTNodeCameraView root, int commandId, @Nullable ReadableArray args) {
        switch (commandId) {
            ...
            case COMMAND_RELEASE_CAMERA_ID:
                root.release();
                break;
        }
    }
